...
We welcome all contributions to openmm-mdanalysis-reporter!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/sef43/openmm-mdanalysis-reporter/issues)
...
The second two options both involve making a [pull request](https://github.com/sef43/openmm-mdanalysis-reporter/pulls) .
